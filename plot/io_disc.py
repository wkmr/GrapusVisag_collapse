...
profilekeys = ['r','sigma','cs','kappa','gamma','mu', 'T', 'tau', 'nu','alpha', 'Q', 'torque']

profilelabels = [r'r (AU)',r'$\Sigma$ (g cm $^{-2}$)',r' $c_s$ (cm s$^{-1}$)',r'$\kappa$ (cm$^{2}$ g$^{-1}$)',
           r'$\gamma$',r'$\mu$',r'$T_c$ (K)',r'$ \tau $',r'$\nu_g$',r'$\alpha_{g}$',r'$ Q $',r'torque']
profilexlabel = profilelabels[0]

# Log the y axis? True/False
profileylog=[True, True, True,True,False,False,True,True,True,True,True,False]
...
#            t, iplanet,nactive = read_planets(planetfiles[i],verbose=False)
