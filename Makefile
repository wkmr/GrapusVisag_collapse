...
#FFLAGS = -O3 -frecord-marker=4 -fdefault-real-8 -fdefault-double-8 -fimplicit-none -fbounds-check -ffpe-trap=invalid,zero,overflow -Wunused -fbacktrace -fcheck=all
